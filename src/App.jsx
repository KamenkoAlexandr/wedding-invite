...
const TIPS = [
  ...
  {
    title: 'Сюрпризы',
    text: 'Приветствуются Ваши поздравления, активное участие и творческие выступления. \nВы можете обратиться к организатору для воплощения своих идей!',
  },
]
...
const App = () => {
  ...
  return (
    <main className="invite-page">
      ...
      {/************************ БЛОК ИГРА НАЧАЛО  *************************/}
      <section className="section game-section" style={{ marginTop: '108px' }}>
        <SectionTitle>
      ...
      <section className="section" style={{ marginTop: '100px' }}>
        ...
        <p>
          ...
          нашем празднике до 1 августа 2026.
        </p>
        <p>
      ...
      <section className="section">
        ...
        <div className="contacts-row">
          ...
          <a href="tel:+375333337014" target="_blank">
      ...
      <section className="section">
        <p className="closing">
          Здесь мы станем семьей - <br /> вместе с Вами.
        </p>
        <Divider />
